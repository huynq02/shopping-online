...
{
    public class removeShip : RemoteAttribute
    {
        ...
        public removeShip(string routeName) : base(routeName) { }
        public removeShip(string action, string controller) : base(action, controller) { }
        public removeShip(string action, string controller,
