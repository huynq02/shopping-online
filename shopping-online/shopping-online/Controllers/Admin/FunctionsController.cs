...
namespace shopping_online.Controllers.Admin
{
    public class FunctionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "function_id,function_name,function_description,function_ordernumber,function_createday")] Function function)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "function_id,function_name,function_description,function_ordernumber,function_createday")] Function function)
        {
            if (ModelState.IsValid)
            {
