...
INSERT [dbo].[Account] ([account_id], [account_username], [account_password], [account_email], [account_name], [account_phone], [account_address], [account_role_id], [account_gender], [account_DOB]) VALUES (1002, N'namanhsan', N'123456789', N'phuong', N'phuong', N'phuong', N'phuong', 1, 1, CAST(N'2001-06-06' AS Date))
SET IDENTITY_INSERT [dbo].[Account] OFF
GO

SET IDENTITY_INSERT [dbo].[Order] ON 

INSERT [dbo].[Order] ([Order_id], [account_id], [Order_note], [Order_status_id], [Order_total_money], [Order_Date], [shipping_id]) VALUES (1, 8, N'oke', 4, 5722, CAST(N'2020-06-15' AS Date), 7)
INSERT [dbo].[Order] ([Order_id], [account_id], [Order_note], [Order_status_id], [Order_total_money], [Order_Date], [shipping_id]) VALUES (2, 2, N'sắp oke', 2, 8327, CAST(N'2021-07-09' AS Date), 3)
